...
(function ($) {
  $.fn.waterTank = function (options, extra) {
    ...
    jQuery.extend(jQuery.easing, {
      ...
      _easeInQuart: function (t) {
        return t * t * t * t;
      },
      _easeOutQuart: function (t) {
        return 1 - --t * t * t * t;
      },
      _easeInOutQuart: function (t) {
        return t < 0.5 ? 8 * t * t * t * t : 1 - 8 * --t * t * t * t;
      },
      _easeInQuint: function (t) {
        return t * t * t * t * t;
      },
      _easeOutQuint: function (t) {
        return 1 + --t * t * t * t * t;
      },
      _easeInOutQuint: function (t) {
      ...
      $that
        ...
        .animate(
          ...
          },
          {
            duration: speed,
            step: function () {
              $that.find("._balance").css("overflow", "visible");
            },
            complete: function () {
              $that.find("._balance").css("overflow", "visible");
            },
      ...
      $that
        ...
        .animate(
          ...
          },
          {
            duration: speed,
            step: function () {
              $that.find("._filled").css("overflow", "visible");
            },
            complete: function () {
              $that.find("._filled").css("overflow", "visible");
            },
    ...
    if (typeof options == "number") {
      ...
      if (options == "screenshot") {
        ...
        rect(
          ctx,
          x,
          Number(y + $balance.height() + $filled.height()),
          $balance.width(),
          $this.find("._reflect").height(),
          gradient
        );
        ...
        ellipse(
          ctx,
          x,
          Number(y + $balance.height() + $filled.height()) - ovalHeight / 2,
          $balance.width(),
          ovalHeight,
          color,
          0,
        ...
        ellipse(
          ctx,
          x,
          Number(y + $balance.height()) - ovalHeight / 2,
          $balance.width(),
          ovalHeight,
          color
        );
        ...
        ctx.fillStyle = "#000";
        ctx.fillText(
          $this.find("._percentageTag").text(),
          Number(x + $balance.width() + 15),
          Number(y + $balance.height() - 10)
        );
            ...
            for (var y = 0; y < _height; y++) {
              for (var x = 0; x < _width; x++) {
                ...
                if (old_data != data) {
                  ...
                  b =
                    ((((y - _half_height) * data) / 1024) << 0) + _half_height;
