...
$(document).ready(function () {
  startConnect();
  var msg = JSON.parse(
    '{"temp":"34","hue":"10","gas":"10","level":"50","motor":"0","door":"0","light":"0","fan":"0"}'
  );
  set_data(msg, msg);
  ...
  function set_data(data, old_data) {
    ...
    if (temp > 32) {
      ...
      $("#temp-icon").addClass("fad fa-temperature-hot fa-2x");
      $("#temp-icon").css("--fa-primary-color", "orange");
      $(".Temperature").css({ color: "orange" });
    } else if (temp > 20) {
      $("#temp-icon").removeClass();
      $("#temp-icon").addClass("fad fa-thermometer-half fa-2x");
      $("#temp-icon").css("--fa-primary-color", "gold");
      $(".Temperature").css({ color: "gold" });
    } else {
      $("#temp-icon").removeClass();
      $("#temp-icon").addClass("fad fa-temperature-frigid fa-2x");
    ...
    if (hue > 30 && hue < 50) {
      ...
      $("#humid-icon").addClass("fad fa-humidity fa-2x");
    ...
    if (pump == 1) {
      ...
      $("#pump-icon").addClass("fad fa-faucet-drip fa-2x");
      $("#pump-icon").css({
      ...
      $("#pump-icon").removeClass();
      $("#pump-icon").addClass("fad fa-faucet fa-2x");
      $("#pump-icon").css({
        "--fa-secondary-opacity": "1.0",
    ...
    if (door == 1) {
      ...
      $("#door-icon").addClass("fad fa-door-open fa-2x");
      $("#door-icon").css({
        "--fa-secondary-opacity": "1.0",
      ...
      $("#door-icon").removeClass();
      $("#door-icon").addClass("fad fa-door-closed fa-2x");
      $("#door-icon").css({
        "--fa-secondary-opacity": "1.0",
        "--fa-primary-color": "#50a5bf",
        "--fa-secondary-color": "#94593b",
    ...
    if (light == 1) {
      ...
      $("#light-icon").addClass("fad fa-lightbulb-on fa-2x");
      $("#light-icon").css({
        "--fa-secondary-opacity": "1.0",
      ...
      $("#light-icon").removeClass();
      $("#light-icon").addClass("fad fa-lightbulb fa-2x");
      $("#light-icon").css({
        "--fa-secondary-opacity": "1.0",
        "--fa-primary-color": "gold",
        "--fa-secondary-color": "#707070",
    ...
    if (fan == 1) {
      ...
      $("#fan-icon").addClass("fad fa-lightbulb-on fa-2x");
      $("#fan-icon").css({
        "--fa-secondary-opacity": "1.0",
        "--fa-primary-color": "gold",
        "--fa-secondary-color": "#707070",
      ...
      $("#fan-icon").removeClass();
      $("#fan-icon").addClass("fad fa-lightbulb fa-2x");
      $("#fan-icon").css({
        "--fa-secondary-opacity": "1.0",
        "--fa-primary-color": "gold",
        "--fa-secondary-color": "#707070",
